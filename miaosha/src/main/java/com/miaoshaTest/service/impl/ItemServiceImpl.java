...
import com.miaoshaTest.dao.ItemDOMapper;
import com.miaoshaTest.dao.ItemStockDOMapper;
import com.miaoshaTest.dataobject.ItemDO;
import com.miaoshaTest.dataobject.ItemStockDO;
...
public class ItemServiceImpl implements ItemService {
    ...
    private ItemStockDO convertItenStockDOFromItemModel(ItemModel itemModel){
        if(itemModel==null){
            return null;
        }
    ...
    public ItemModel createItem(ItemModel itemModel) throws BusinessException {
        ...
        ItemStockDO itemStockDO=this.convertItenStockDOFromItemModel(itemModel);
